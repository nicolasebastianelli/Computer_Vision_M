...
int main(int argc, char*argv[]){
	...
	while (!exit){
		...
		if (choice == 1){
			...
			int kernel_side = 3; // kernel side size
			std::vector<float> kernel(kernel_side*kernel_side);
			//uncomment only one of the two kernel at time
			//float k[9] = { 1/16.0, 2/16.0, 1/16.0, 2/16.0, 4/16.0, 2/16.0, 1/16.0, 2/16.0, 1/16.0 }; //blur 3x3
			//float k[25] = {2/159.0, 4/159.0 ,5/159.0, 4/159.0, 2/159.0, 4/159.0, 9/159.0, 12/159.0, 9/159.0, 4/159.0, 5/159.0, 12/159.0, 15/159.0, 12/159.0, 5/159.0, 4/159.0, 9/159.0, 12/159.0, 9/159.0, 4/159.0, 2/159.0, 4/159.0, 5/159.0, 4/159.0, 2/159.0}; // blur 5x5
			float k[9] = { 0, 1, 0, 1, -4, 1, 0, 1, 0 }; // edje detection 3x3
			//float k[25] = { 0,0,1,0,0,0,1,2,1,0,1,2,-16,2,1,0,1,2,1,0,0,0,1,0,0 }; // edje detection 5x5
			kernel.assign(k,k+ kernel_side*kernel_side);
