...
int main(int argc, char*argv[]){
	...
	//========================TO DO:EXERCISE 1=========================
	//Load in source_image the image located at image_filepath
	source_image = cv::imread(image_filepath,0);
	//================================================================
	...
	inverted_image = cv::Mat(source_image.size(), source_image.type());
	//=================================================================
	...
	//=======================TO DO: Exercise 2=========================
	//Assign to each pixel of inverted_image 255-the corresponding pixel in source_image either using nested loops or linear algebra function.
	...
	//Modify all the code above to load a color image and invert all the three channels
	//=================================================================
	image_filepath = "../../data/munch.jpg";

	source_image = cv::imread(image_filepath);
	cv::imshow("Color Image",source_image);
	inverted_image = cv::Scalar(255,255,255)-source_image;
	cv::imshow("inverted image",inverted_image);
	...
	//Image difference
	//=================================================================
	std::string image_filepath1 = "../../data/fd1.bmp";
	std::string image_filepath2 = "../../data/fd2.bmp";
	cv::Mat source_image1 = cv::imread(image_filepath1,0);
	cv::Mat source_image2 = cv::imread(image_filepath2,0);
	cv::imshow("fd1",source_image1);
	cv::imshow("fd2",source_image2);
	cv::Mat out_image = cv::abs(source_image1-source_image2); 
